...
timelog:
  ...
  - activity: 
      ...
      duration: PT15M
  - activity: 
      description: secondary methods section transcription.
      who: AmandaLopez14
      start: 2026-09-09 T0130
      duration: PT60M
  - activity:
      description: transcribed table 1.
      who: laylakalandjian
      start: 2026-09-16 T1415
      duration: PT30M
  - activity:
      description: transcribed table 2 and cross-checked methods section.
      who: laylakalandjian
      start: 2026-09-16 T1945
      duration: PT45M
  - activity:
      description: transcribed tables 3 and 5.
      who: laylakalandjian
      start: 2026-09-17 T1415
      duration: PT30
...
table1.file <- 'LadoMonserrat2016_Table1.csv'
table2.file <- 'LadoMonserrat2016_Table2.csv'
table3.file <- 'LadoMonserrat2016_Table3.csv'
table5.file <- 'LadoMonserrat2016_Table5.csv'
figure3.file <- 'LadoMonserrat2016_Figure3.csv'
figure4.file <- 'LadoMonserrat2016_Figure4.csv'
...
- [LadoMonserrat2016_Table1.csv](LadoMonserrat2016_Table1.csv)
  + table 1 from primary article with ...
- [LadoMonserrat2016_Table2.csv](LadoMonserrat2016_Table2.csv)
  + table N from primary article with ...
- [LadoMonserrat2016_Table3.csv](LadoMonserrat2016_Table3.csv)
  + table N from primary article with ...
- [LadoMonserrat2016_Table5.csv](LadoMonserrat2016_Table5.csv)
  + table N from primary article with ...
- [temp/](temp/)
...
+ Do
  ...
  - [ ] Create a spreadsheet with Table3 and export it to csv
    - [ ] Create a spreadsheet with Table5 and export it to csv
...
diff --strip-trailing-cr --suppress-common-lines -y temp/LadoMonserrat2016_Table1_AL.csv LadoMonserrat2016_Table1.csv
```


## Table 1

Table 1 was modified by combining caption with transcribed table title.
Values intentionally left blank were filled in with NA.
Superscripts in column labels were denoted with Markdown.
...
diff --strip-trailing-cr --suppress-common-lines -y temp/LadoMonserrat2016_Methods_AL.md LadoMonserrat2016_Methods.md
```
