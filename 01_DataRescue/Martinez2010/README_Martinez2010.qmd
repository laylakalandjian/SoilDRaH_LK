...
+ Lead
  ...
  - [ ] Create a fresh fork of the primary repository https://github.com/ktoddbrown/SoilDRaH/tree/main, it might be useful to rename it 'SoilDRaH_Martinez2010'
  - [ ] Create a copy of this template folder and rename it to Martinez2010
...
+ Do
  ...
  - [ ] Create a spreadsheet with Figure1 and export it to csv
...
<<<<<<< HEAD
diff --strip-trailing-cr --suppress-common-lines -y Martinez2010_Table1.csv Martinez2010_Table1_AC.md
=======
diff --strip-trailing-cr --suppress-common-lines -y Martinez2010_Table1.csv Martinez2010_Table1_AC.csv
>>>>>>> 3da55549dcf50b2472e7dd1ec160adc724883cac
```
...
=======
diff --strip-trailing-cr --suppress-common-lines -y Martinez2010_Table2.csv Martinez2010_Table2_AC.csv
>>>>>>> 3da55549dcf50b2472e7dd1ec160adc724883cac
```
...
diff --strip-trailing-cr --suppress-common-lines -y Martinez2010_Figure1.csv Martinez2010_Figure1_MA.csv
```
...
# You will want to repeat the line below to cross check each csv and md file in the
#... data rescue. Having no lines flagged by this command will ensure that each character matches exactly.
diff --strip-trailing-cr --suppress-common-lines -y Martinez2010_Methods_MA.md Martinez2010_Methods_VM.md
```
