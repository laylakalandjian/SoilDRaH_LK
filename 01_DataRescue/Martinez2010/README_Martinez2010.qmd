...
Tables
Table 1: Litter chemical composition of Acacia caven and Lolium multiflorum before field incubation.
Table 2: Decomposition rate (k) and weight loss (A) at 420 days for Acacia caven and Lolium multiflorum litter.
Table 3: Correlation matrix of principal components for Acacia caven and Lolium multiflorum.

Figures
Figure 1: Weight loss as a percentage of initial weight for Acacia caven and Lolium multiflorum in a degraded ecosystem
(De), typical ecosystem (Pd), and well preserved ecosystem (Wp) over 450 days.
Figure 2: Two-dimensional graph for PC1 and PC2 of Acacia caven litter with the variables under study
Figure 3: ANOVA (p < 0.001) for PC1 (a) and PC3 (b) factors for Acacia caven.
Figure 4: ANOVA (p < 0.001) PC2 factor for Acacia caven.
Figure 5: Two-dimensional graph for Lolium multiflorum, correlations of PC1 and PC2 principal components with each variable under study.
...
#| eval: false
>>>>>>> 10be01a40b998a77808530199233192ba45fa54f
