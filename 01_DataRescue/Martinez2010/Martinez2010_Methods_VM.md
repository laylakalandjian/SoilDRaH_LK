...
NDF is the structural residue that includes hemicellulose (NDF-ADF), cellulose (ADF-ADL), lignin (ADL), and non-structural components (100-NDF) (McTiernan et al., 2003).
...
Colorimetry was applied to determine P (Colorimeter Helios Epsilon, Unicam, Berlin, Germany) (Sadzawka, 2006).
...
This model is well-adjusted to initially high decomposition (Dalias et al., 2001; Berg and Laskowski, 2006).
