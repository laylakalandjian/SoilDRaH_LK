...
bibliography:
  - Kumada2008_Methods.bib #contains the citations in the methods section
  - Kumada2008.bib #contains citation for the data source, generally a single citation of the primary paper
...
timelog:
  ...
  - activity:
      ...
      duration: PT45M
  - activity: 
      description: created github issue, readme setup and initial paper readthrough
      who: laylakalandjian
      start: 2026-09-01 T1100
      duration: PT30M
  - activity: 
...
methods.file <- "Kumada2008_Methods.md"
tableN.file <- 'AuthorYYYY_TableN.csv'
figureM.file <- 'AuthorYYYY_FigureM.csv'

# Bibliography files
primaryCitation.file <- 'Kumada2008.bib'
methodsCitation.file <- 'Kumada2008_Methods.bib'
...
Kumada, Shungo, et al. ‘Litter Carbon Dynamics Analysis in Forests in an Arid Ecosystem with a Model Incorporating the Physical Removal of Litter’. Ecological Modelling, vol. 215, no. 1, 2008, pp. 190–199, https://doi.org/10.1016/j.ecolmodel.2008.02.022.

For the discussion of this data rescue see the Github issue: https://github.com/ktoddbrown/SoilDRaH/issues/#304.

Kumada2008 expands on an established project to develop and evaluate techniques for arid land afforestation and reforestation at specific sites in Western Australia.
As part of the project, Kumada uses this paper to develop a litter and soil carbon dynamics model for arid land afforestation, using field experiments and parameters established in previous papers.
They use this data to investigate the physical removal of litter versus the natural decomposition of two subcategories of organic litter, denoted leaf litter and woody litter.
Estimated carbon balances of three acacia forest sites are then presented as carbon flow models.

## Tables and figures

- Table 
  1) Carbon pools, litter fall rate constant and fractions of the leaf and woody litter to litter production in Sturt Meadows.
  2) Litter decomposition parameters including decomposition rate constants, initial mass fractions, and site number.
  3) Estimated value of the steady state amount of litter carbon without physical removal, and the observed value.
  4) Estimated rate constant for physical removal, removal constant, and ratio of physically removed litter to litter fall.

- Figure 
  1) Map of research area in Western Australia.
  2) Map of study sites in Sturt Meadows.
  3) Photos of appearance of forest physiognomy in 3 study sites.
  4) Carbon flow diagram for litter part model.
  5) Transition of the litter amount without physical litter removal in several natural acacia forests in 3 study sites.
  6) Carbon amount and flux in several natural acacia forests with physical litter removal, presented as carbon flow diagrams.
...
The Decomposition Across Drylands (DeAD) data collection is a new data effort targeting dryland decomposition studies. The purpose of this data collection is to develop better litter decay models for dryland ecosystems. This paper has been identified as a source for the information above.
  ...
  - Location: Research area identified in subsection 2.1 Site description in the Methods section, with latitude and longitude given. A more detailed description of the research area and studied sites is available in a previous paper cited Kojima et al. (2006) in the same section.
  - Duration: Duration not provided, as authors use previous data collection on the same project to create a carbon flow model.
  - Mass Loss: Litter decomposition rate constants provided for fast and slow decomposing leaf and woody litter, as well as initial mass fractions.
  - Solar Exposure: Solar exposure not provided.
  
## Files

These files are in the Kumada2008 data rescue.

- [Readme](README_Kumada2008.qmd)
  + This is the primary file that documents the transcriptions and decision made during data rescue.
- [Kumada2008.bib](Kumada2008.bib)
  + citation for article transcribed
- [Kumada2008_Methods.bib](Kumada2008_Methods.bib)
  + citations for the methods section of the article
- [Kumada2008_Methods.md](Kumada2008_Methods.md)
